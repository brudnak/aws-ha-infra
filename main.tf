...
# RKE Import Cluster for Reproduction server.
module "high-availability-infrastructure-rke-import-repro" {
  source                = "./modules/aws-high-availability-infrastructure"
  aws_prefix            = var.aws_prefix
  aws_access_key        = var.aws_access_key
  aws_secret_key        = var.aws_secret_key
...
# RKE Import Cluster for Validation server.
module "high-availability-infrastructure-rke-import-valid" {
  source                = "./modules/aws-high-availability-infrastructure"
  aws_prefix            = var.aws_prefix
  aws_access_key        = var.aws_access_key
  aws_secret_key        = var.aws_secret_key
